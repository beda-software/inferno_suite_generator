...
module InfernoSuiteGenerator
  class Generator
    class BasicTestGenerator
      ...
      def test_id
        case template_type
        when TEMPLATE_TYPES[:PATCH], TEMPLATE_TYPES[:UPDATE], TEMPLATE_TYPES[:READ], TEMPLATE_TYPES[:VALIDATION], TEMPLATE_TYPES[:REFERENCE_RESOLUTION], TEMPLATE_TYPES[:MUST_SUPPORT], TEMPLATE_TYPES[:CREATE]
